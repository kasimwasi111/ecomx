        ...
        <div className="container-xxl">
          <div className="row justify-content-center justify-content-md-start">
            <div className="col-md-4 col-lg-4 mb-4 mb-md-0 ">
              ...
              <div className="mb-3">
                <p>
                  <b>Address:</b>Madhuban Road, The Titan Building, 2nd floor,
                  Mau U.P (275304)
                </p>{" "}
              </div>
              <div className="mb-3">
                <p>
                  ...
                  <a className="footer-tel" href="tel:+1234567890">
                    Call us at +91 (951) 766-8449
                  </a>
                </p>{" "}
              </div>
              <div className="mb-4">
                <p>
                  <b>Hours:</b> Morning 8 a.m To Evening 8 p.m
                </p>{" "}
              </div>
              <div className="mb-3">
                <p>
              ...
              <div className="socials d-flex gap-3">
                <Link
                  to="https://github.com/kasimwasi111"
                  id="footer-link"
                  target="_blank"
                  className="gap-3"
                >
                ...
                <Link
                  to="https://www.linkedin.com/in/mohammad-kasim-1386a0152/"
                  id="footer-link"
                  target="_blank"
                  className="gap-3"
                >
            ...
            <div className="col-md-2 col-lg-2 mb-3 mb-md-0">
              ...
              <div className="mb-3">
                {" "}
                <Link id="footer-links">Help</Link>{" "}
              </div>
              <div className="mb-3">
                {" "}
          ...
          <div className="row">
            <div className="col-12 col-md-6">
              <p className="text-center text-md-start">
                &copy;Developed by Mohammad Kasim Wasi
              </p>
            </div>
            <div className="col-12 col-md-6">
